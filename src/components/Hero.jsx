      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-1 px-6 pt-40 pb-20 text-center">
        ...
        >
          ...
          <a
            ...
            className="px-8 py-4 rounded-full glass border-[#C9A96E]/15 text-white/70 font-medium text-[15px] hover:text-white hover:bg-white/[0.06] hover:border-[#C9A96E]/30 transition-all flex items-center gap-2.5"
          >
