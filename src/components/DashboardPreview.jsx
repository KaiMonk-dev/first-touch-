...
const mockStats = [
  ...
  { label: 'Appointments Booked', value: '156', change: '+23%' },
  { label: 'Avg Response Time', value: '0.8s', change: '-15%' },
  { label: 'Review Requests Sent', value: '89', change: '+8%' },
]
    ...
    <section className="relative py-28 md:py-36 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <AnimatedSection delay={300}>
          <div className="rounded-2xl liquid-glass-strong overflow-hidden liquid-shimmer">
            {/* Dashboard header */}
                ...
                {mockStats.map((stat, i) => (
                  <div key={i} className="p-4 rounded-xl bg-white/[0.03] border border-white/[0.04]">
                    ...
                    <div className="flex items-baseline gap-2">
                      <span className="text-xl font-bold text-white/90 tabular-nums">{stat.value}</span>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className={`text-[10px] font-medium px-2 py-0.5 rounded-full ${
                        call.result === 'Booked'
                          ...
                          : call.result === 'Qualified'
                          ? 'bg-[#C9A96E]/10 text-[#C9A96E]/70'
