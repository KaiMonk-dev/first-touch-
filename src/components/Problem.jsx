      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <AnimatedSection delay={200}>
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-[-0.03em] leading-[0.9] mb-24">
            ...
            <br />
            <span className="bg-gradient-to-b from-white/90 to-white/50 bg-clip-text text-transparent">Missed Calls.</span>
          </h2>
        </AnimatedSection>
          ...
          {stats.map((stat, i) => (
            <AnimatedSection key={i} delay={400 + i * 200}>
              <div className="space-y-5">
                <p className="text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-[-0.04em] bg-gradient-to-b from-white to-white/30 bg-clip-text text-transparent">
                  {stat.value}
                </p>
                <p className="text-sm text-white/50 max-w-[220px] mx-auto leading-relaxed font-light">
                  {stat.label}
                </p>
              </div>
            </AnimatedSection>
