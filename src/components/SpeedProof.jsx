        ...
        <AnimatedSection delay={300}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-10 rounded-2xl liquid-glass card-hover text-center">
              ...
              <div className="mb-4">
                <span className="text-6xl md:text-7xl font-extrabold tracking-tight text-white/40 tabular-nums">
                  {counting ? competitorTime.toFixed(1) : '0.0'}
                </span>
                <span className="text-2xl text-white/20 font-light ml-1">hrs</span>
              </div>
